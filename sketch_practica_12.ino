// declaramos variables globales columnas, filas,periodo,millisegundos,pines, y la distribucion de nuestro teclado formado por los pines
...
const byte columnsPins[countColumns] = { 5, 4, 3, 2 };
...
void loop()
{
  if (millis() - prevMillis > period)   // Espera no bloqueante
  {
    ...
    {
      Serial.println(keys[iRow][iCol]);   // Mostrar tecla con puerto serial
    }
  }
}
